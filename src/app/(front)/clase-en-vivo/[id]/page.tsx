...
import { CalendarDays, Clock, GraduationCap, Info, MoreVertical, NotebookPen } from 'lucide-react';
  ...
  return (
    <div>
      <div className="h-auto">
        ...
        {/* <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-0 "></main> */}
            ...
            <div className="w-full self-start">
              <Card className="dark:bg-card bg-background  ">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3 dark:text-[#A7A7A7] text-black font-poppins text-sm sm:text-base ">
                    ...
                    <div className="flex items-center gap-3 dark:text-[#A7A7A7] text-black font-poppins text-sm sm:text-base ">
                      <GraduationCap className="text-slate-500 h-4 w-4 sm:h-5 sm:w-5 " />
                      Categoria:<span className="text-white"> {course.category}</span>
                    </div>
                    <div className="flex items-center gap-2 sm:gap-3 dark:text-[#A7A7A7] text-black font-poppins text-sm sm:text-base ">
                      <CalendarDays className="text-slate-500 h-4 w-4 sm:h-5 sm:w-5 " />
              ...
              <div>
                <div className="flex  mb-4 gap-3 py-6 w-[300px] ">
                  <div className="bg-[#702DFF] dark:text-white text-white font-bold rounded-2xl p-3 text-start flex items-center justify-center gap-2">
                    <span className="text-[68px] md:text-[74px] font-groteskSharpBold10">
                      {/* {completedCourses[0]?.completedCourses} */}
                      {completedCourses}
                    </span>
                    <span className="text-[26px] md:text-3xl leading-[1.7rem] md:leading-[2rem] font-groteskSharpBold10 tracking-wide ">
                      {completedCourses === 1 ? 'CURSO COMPLETADO' : 'CURSOS COMPLETADOS'}
                    </span>
                  </div>
                  <div className="bg-[#E0EAF3] dark:text-[#702DFF] text-[#702DFF] font-bold rounded-2xl p-3 text-start flex items-center justify-center gap-2">
                    <span className="text-[68px] md:text-[74px] font-groteskSharpBold10">
