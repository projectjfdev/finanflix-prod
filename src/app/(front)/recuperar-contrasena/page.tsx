...
export default function PasswordRecoveryPage() {
  ...
  return (
    <div className="min-h-screend dark:bg-background bg-white ">
      <main className="container mx-auto px-4 py-10 dark:bg-background bg-white">
        {/* Hero Section */}
        <section className="text-center py-5 md:py-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-10 dark:text-white text-black">
          ...
          <Card className="mt-8 flex flex-col justify-center items-center text-green-600 py-10 px-3 md:px-0 ">
            <div className="w-full flex justify-center items-center   pb-3">
              <Shield className="hidden md:flex mr-2" size={24} />
              <span className="font-semibold text-3xl">Tu seguridad, nuestra prioridad</span>
            </div>

            <span className=" md:text-lg max-w-4xl mx-auto text-gray-600 w-full dark:text-white ">
        ...
        {/* Steps Section */}
        <section className="py-5  dark:bg-background border bg-white rounded-lg ">
          <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center dark:text-white text-black">
          ...
          <div className="mt-8 text-center space-y-5">
            <p className="dark:text-white text-gray-600 flex items-center justify-center text-lg ">
            ...
            <Link
              target="_blank"
              className="dark:text-white dark:hover:text-gray-300 text-gray-600 flex items-center justify-center text-lg "
              href={
        ...
        <section className="py-10 px-5 md:px-0  text-center bg-secondary  text-white rounded-2xl">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">Un nuevo comienzo en Finanflix</h2>
          <p className="text-lg md:text-xl mb-6 max-w-2xl mx-auto">
            Aprovecha esta oportunidad para redescubrir todo lo que tenemos para ofrecerte en
            nuestra nueva plataforma.
          </p>
          <div className="flex justify-center items-center">
            <Sparkles className="mr-2" size={24} />
            <span className="font-semibold">Estamos aquí para ayudarte</span>
          </div>
          <p className="mt-2">
            Nuestro objetivo es hacer esta transición lo más sencilla posible. Si necesitas ayuda,
          ...
          >
            <div className="px-20 hover:bg-gray-800 bg-primary py-3 mx-auto rounded-full text-base md:text-lg">
              Ir A Soporte
            </div>
          </Link>
        </section>
