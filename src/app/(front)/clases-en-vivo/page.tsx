    ...
    <>
      ...
      <div className="min-h-screen dark:bg-background  rounded-lg">
        ...
        aprendizaje."
          ...
          <div className="flex items-center pt-6 justify-center md:justify-start">
            <span className="font-bold  text-base text-primary mr-1">
            ...
            {(q !== 'all' && q !== '') || category !== 'all' ? (
              <Link href="/clases-en-vivo">
                <Card className="w-full flex gap-3 ml-5 items-center justify-center md:px-2 py-2 dark:hover:bg-primary">
          ...
          <div className="flex items-center mb-10 mt-4 gap-1 dark:hover:text-[#E7E3E3] hover:text-black  text-[#BCBCBC] dark:bg-card bg-white rounded-full px-3 py-1 md:w-fit w-full">
                ...
                <Link key={c} href={getFilterUrl({ c })}>
                  <Button
                    ...
                    className={cn(
                      ...
                      c === category
                        ? ' hover:bg-primary/90 dark:bg-secondary  dark:text-white text-sm'
                        : '  hover:bg-muted hover:text-foreground dark:hover:text-white  hover:bg-primary hover:text-white text-[#A7A7A7] text-sm'
                    )}
                  >
                    {c}
                  </Button>
          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 pt-4 gap-10">
              ...
              return (
                ...
                >
                  <Card className="flex bg-white dark:bg-card flex-col w-full border-none rounded-2xl">
                    ...
                    <CardContent className="flex-grow py-4 space-y-2 pl-4">
                      <h3 className="text-xl font-semibold mb-2 dark:text-white text-black truncate">
                        {c.title}
                      </h3>
                    ...
                    <CardFooter className="py-3 pt-0 pl-4">
                      ...
                      <div className="w-full space-y-2 ">
                        {/* <div className="w-full dark:bg-[#474666] bg-[#474666] rounded-full h-2">
                        <Progress
                          value={progressValue} // Usamos el valor calculado de la barra de progreso
                        ...
                        <div className="flex justify-between items-center py-2">
                          ...
                          <p className="text-sm dark:text-[#A7A7A7] text-black pt-1 pr-4">
                            {c?.lessonDate
