...
export default function Setting() {
  ...
  // FUNCIONALIDAD ELIMINAR CUENTA - SUSPENDIDA
  // const handleDeleteAccount = async (id: string) => {
  //   try {
  //     // Verifica si el usuario confirmó correctamente
  //     if (
  //       confirmDeleteValue.trim().toLowerCase() === "quiero-borrar-mi-cuenta"
  //     ) {
  ...
  //             label: "Cerrar",
  //             onClick: () => {
  //               window.close(); // Considera si esto es lo mejor para UX
  //             },
  //           },
  //         });
  //       } else {
  //         toast.error("Error al eliminar la cuenta", {
  //           description: res.message || "Inténtalo nuevamente más tarde.",
  //         });
  //       }
  //       return res; // Si realmente necesitas devolver el resultado
  //     } else {
  ...
  //       description: "No se pudo eliminar la cuenta. Inténtalo más tarde.",
  //     });
  //   }
  // };
      ...
      <div>
        ...
        <Form {...form}>
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col">
              ...
              <div className="dark:bg-[#4C2FBA] h-[200px] w-screen ml-[calc(-50vw+50%)] md:hidden relative bottom-[150px] z-[50] flex items-center justify-center ">
                ...
                <div className="w-full flex items-center relative px-4">
                  ...
                  <div className="flex-grow flex justify-center">
                    <p className="text-white text-lg font-semibold z-[55] mr-6">Tu cuenta</p>
                  </div>
                </div>
            ...
            {/* <AlertMessage messageRes={messageRes} /> */}

            {showSuccessModal && (
              <SuccessModal
                success={messageRes!.success}
                text={messageRes!.message}
