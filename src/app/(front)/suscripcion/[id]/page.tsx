...
export default function CheckoutSuscriptionPage() {
  ...
  return (
    <div className="w-full -z-10 sm:px-3 md:px-10 lg:px-20 xl:px-40 md:w-screen md:ml-[calc(-50vw+50%)] pb-40">
      ...
      <div className="relative top-60 lg:top-72 2xl:top-64 shadow-xl dark:shadow-[0_0_30px_rgba(155,155,155,0.2)] ">
        <Card className="border shadow-2xl pb-20 ">
          <div className="grid lg:grid-cols-2 gap-8 md:ml-10 pt-5 md:pt-10">
                ...
                <Card className=" dark:text-white text-black px-3 font-poppins border-none">
                  ...
                  {step === 'billing' && (
                    ...
                    <div className='flex md:flex-row flex-col'>
                      <h2 className="font-poppins font-extralight text-sm whitespace-nowrap mt-1">
                        PASO <span className="font-[500]">3</span> DE <span className="font-[500]">4</span>
                      </h2>

                      {suscription?.frequencyType === 'mensual' && (
                        <BigTitle
                          className="text-6xl 2xl:text-[5rem] mb-3 md:mb-10 ml-3 md:ml-0 break-all font-groteskSharpBold10 w-full text-center"
                      ...
                      <CardHeader>
                        <CardTitle className="text-xl font-poppins">Información Personal</CardTitle>
                  ...
                  {step === 'payment' && (
                    <div>
                      {suscription?.frequencyType === 'mensual' && (
                        <BigTitle
                          className="text-6xl md:text-[5rem] md:mb-3  ml-3 md:ml-0  break-all font-groteskSharpBold10 w-full text-center"
                          title="EMPIEZA GRATIS AHORA"
                        />
                      )}
              ...
              <Card className="dark:text-white text-black border border-none">
                <CardContent className="px-3 md:px-0  w-full md:w-[80%]">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                      <h4 className="font-semibold mb-2 text-xl md:text-2xl font-poppins">
                        Desbloquearás inmediatamente:
                      </h4>
                      <div className="dark:text-gray-300 text-gray-600 text-sm break  flex flex-col">
                        {type === 'diamond' ? (
                          <div>
                            <p>
                          ...
                          // suscription?.features?.map((feature, index) => (
