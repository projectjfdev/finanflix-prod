...
function TerminosCondicionesPage() {
  return (
    <div className="px-6 text-normal md:px-0 flex flex-col gap-7 md:text-justify  mx-auto   mb-10 pt-5 ">
      ...
      <div className="text-center">
        <BigTitle
          className="pb-3 pt-[21px] text-2xl px-5 md:pt-5"
      ...
      {terms1.map((term, index) => (
        <div key={index}>
          ...
          <div className="mt-[1rem]">{term.description}</div>
          <div className="mt-[1rem]">{term.description2}</div>
        </div>
      ))}
      ...
      {terms2.map((term, index) => (
        <div key={index}>
          ...
          <div className="mt-[1rem]">{term.description}</div>
          <div className="mt-[1rem]">{term.description2}</div>
          <div className="mt-[1rem]">{term.description3}</div>
        </div>
      ))}
      ...
      <Card className="text-start  p-5 dark:text-white text-black w-2/4 ">
        ...
        <div className="flex flex-col gap-3 pt-3">
          ...
          <p className="font-sans text-[16px]">FINANFLIX S.R.L. – Todos los derechos reservados.</p>
        </div>
      </Card>
    </div>
  );
