...
export async function POST(req: Request) {
  ...
  try {
    let mailOptions: any = {
      from: AUTH_EMAIL,
      to: AUTH_EMAIL,
      subject: `${email} ha dejado una compra pendiente en Paypal - "${title}"`,
      html: `
              <!DOCTYPE html>
              <html lang="es">
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                ...
                <tr>
                  <td style="padding-bottom: 20px;" class="email-body">
                    ...
                    <ul style="margin: 10px 0 0; padding-left: 20px; color: #000; font-size: 16px; line-height: 1.5;">
                      <li>ID de la Suscripción cancelada: <b>${suscriptionId}</b></li>
                      <li>ID de la Orden: <b>${orderId}</b></li>
                      <li>Suscripción: <b>${title}</b></li>
                ...
                <tr>
                  ...
                  <ul style="margin: 10px 0 0; padding-left: 20px; color: #000; font-size: 16px; line-height: 1.5;">
                    ...
                    <li>Código Postal: <b>${postalCode}</b></li>
                    <li>Dni: <b>${dni}</b></li>
                  </ul>
                  </td>
                </tr>
