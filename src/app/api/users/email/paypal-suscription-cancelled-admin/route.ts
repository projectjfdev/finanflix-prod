...
export async function POST(req: Request) {
  ...
  const domain = `${process.env.APP_URL}/suscripciones`;
  ...
  try {
    let mailOptions: any = {
      from: AUTH_EMAIL,
      to: AUTH_EMAIL,
      subject: `El usuario ${firstName} ha cancelado la suscripcion - email registrado: ${userEmail}`,
      html: `
<!DOCTYPE html>
<html lang="es">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
          <tr>
            <td style="padding: 20px; text-align: center; background-color: #4C2FBA;" class="email-header">
              <h1 style="margin: 0; color: #ffffff; font-size: 24px; font-weight: bold;">El usuario ${firstName} ha cancelado la suscripcion
              </h1>
            </td>
          </tr>
          <tr>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                ...
                <tr>
                  <td style="padding-bottom: 20px;" class="email-body">
                    <p style="margin: 10px 0 0; color: #666666; font-size: 16px; line-height: 1.5;">A continuación, te compartimos los detalles de la suscripcion cancelada.</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding-bottom: 20px;" class="email-body">
                    ...
                    <ul style="margin: 10px 0 0; padding-left: 20px; color: #000; font-size: 16px; line-height: 1.5;">
                      <li>Titulo de la suscripcion: <b>${suscriptionTitle}</b></li>
                      <li>Id del usuario registrado en Finanflix: <b>${userId}</b></li>
                      <li>Email del usuario registrado en Finanflix: <b>${userEmail}</b></li>
                      <li>Estado actual de la suscripcion: <b>${status}</b></li> 
                      <li>Nombre: <b>${firstName}</b></li> 
                    </ul>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding-bottom: 20px;" class="email-body">
                    <h2 style="margin: 0; color: #333333; font-size: 20px;">Datos de Facturación:</h2>
                    <ul style="margin: 10px 0 0; padding-left: 20px; color: #000; font-size: 16px; line-height: 1.5;">
                      <li>Nombre: <b>${firstName}</b></li> 
                      <li>Apellido: <b>${lastName}</b></li>
                      <li>Pais: <b>${country}</b></li>
                      <li>Direccion: <b>${address}</b></li>
                      <li>Codigo Postal: <b>${postalCode}</b></li> 
                      <li>Dni: <b>${dni}</b></li> 
                      <li>Email de Facturación: <b>${email}</b></li>
                    </ul>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="text-align: center;">
                    <a href=${domain} style="background-color: #4C2FBA; color: #ffffff; text-decoration: none; padding: 12px 30px; font-weight: bold; border-radius: 5px; display: inline-block; font-size: 16px;">Finalizar compra</a>
                  </td> 
                </tr>
