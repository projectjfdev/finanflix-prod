...
export async function POST(req: Request) {
  ...
  //  const {orderId, title, email, priceArg,courseId, firstName, lastName, countryCode, number, country, address, postalCode, dni  } = body;
  ...
  try {
    let mailOptions: any = {
      from: email,
      to: AUTH_EMAIL,
      subject: `${email} ha dejado una compra pendiente en MercadoPago - "${title}"`,
      html: `
<!DOCTYPE html>
<html lang="es">
...
<head>
  ...
  <title>Compra Pendiente Finanflix</title>
  <style>
    ...
    <tr>
      <td style="background-color: #ffffff;">
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
          ...
          <h1 style="margin: 0; color: #ffffff; font-size: 24px; font-weight: bold;">${firstName} ha dejado una compra pendiente en Paypal!
            </td>
          </tr>
          <tr>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                ...
                <tr>
                  <td style="padding-bottom: 20px;" class="email-body">
                    <p style="margin: 10px 0 0; color: #666666; font-size: 16px; line-height: 1.5;"> A continuación, te compartimos los detalles de la orden pendiente de ${firstName}.</p>
                  </td>
                </tr>
                ...
                <tr>
                 ...
                 <tr>
                  <td style="padding-bottom: 20px;" class="email-body">
                    <h2 style="margin: 0; color: #333333; font-size: 20px;">Datos de Facturacion del cliente:</h2>
                  <ul style="margin: 10px 0 0; padding-left: 20px; color: #000; font-size: 16px; line-height: 1.5;">
                    <li>Nombre: <b>${firstName}</b></li>
                    <li>Apellido: <b>${lastName}</b></li>
                    <li>Email: <b>${email}</b></li>
                    <li>Número de teléfono: <b>${countryCode}-${number}</b></li>
                    <li>País: <b>${country}</b></li>
                    <li>Dirección: <b>${address}</b></li>
           ...
           <tr>
            <td
              ...
              <a target="_blank" href="https://discord.gg/NpchEXm5tB"
                style="display: inline-block; margin: 0 5px; text-decoration: none; color: #585858;">Discord</a>
              <p style="margin: 10px 0 0;">© 2024 Finanflix. Todos los derechos reservados.</p>
            </td>
          </tr>
