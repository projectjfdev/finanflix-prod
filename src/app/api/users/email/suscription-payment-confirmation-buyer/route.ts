...
export async function POST(req: Request) {
  ...
  const { reason, price, currencyId, status, createdAt, nextPaymentDate, userEmail, name } = body;
  ...
  try {
    let mailOptions: any = {
      from: AUTH_EMAIL,
      to: userEmail,
      subject: `Confirmación de Compra de Suscripcion - Detalles de Orden - ${userEmail}  "${reason}"`,
      html: `
<!DOCTYPE html>
<html lang="es">
<head>
                ...
                <tr>
                  <td style="padding-bottom: 20px;" class="email-body">
                    ...
                    <ul style="margin: 10px 0 0; padding-left: 20px; color: #000; font-size: 16px; line-height: 1.5;">
                      ...
                      <li>Duración de la Suscripción: <b>${reason} mes o meses</b></li>
                      <li>Importe abonado: <b>$${price}</b></li> 
                      <li>Moneda de Pago: <b>${currencyId}</b></li> 
                      <li>Estado de la compra: <b>${status}</b></li>
