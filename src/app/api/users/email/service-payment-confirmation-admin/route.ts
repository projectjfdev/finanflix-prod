...
export async function POST(req: Request) {
  ...
  const { orderTitle, email, buyerName, courseId, priceArg } = body;
  ...
  try {
    ...
    let mailOptions: any = {
      from: AUTH_EMAIL,
      to: AUTH_EMAIL,
      subject: `${buyerName} ha Comprado el curso "${orderTitle}"`,
      html: `
<!DOCTYPE html>
<html lang="es">
                ...
                <tr>
                  <td style="padding-bottom: 20px;" class="email-body">
                    ...
                    <p style="margin: 10px 0 0; color: #666666; font-size: 16px; line-height: 1.5;"> A
                      continuación, te proporcionamos los detalles de la orden de ${buyerName}.</p>
                  </td>
                </tr>

                <tr>
                  <td style="padding-bottom: 20px;" class="email-body">
                    <h2 style="margin: 0; color: #333333; font-size: 20px;">Informacion de la Orden:</h2>
                    <ul style="margin: 10px 0 0; padding-left: 20px; color: #000; font-size: 16px; line-height: 1.5;">    
                     <li>Nombre del cliente registrado: <b>${buyerName}</b></li>
                     <li>Datos de Facturacion - Email del cliente: <b>${email}</b></li>  
                     <li>ID del curso vendido: <b>${courseId}</b></li>
                     <li>Título del curso vendido: <b>${orderTitle}</b></li>
                    <li>Importe abonado por el cliente: <b>$${priceArg} ARS</b></li>
                    </ul>
                  </td>
                </tr>
