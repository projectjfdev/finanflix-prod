...
export async function POST(req: Request) {
  ...
  const { title, price, email, suscriptionId, bankUSD, bankAR, bank, priceArg } = body;
  ...
  try {
    let mailOptions: any = {
      from: AUTH_EMAIL,
      to: email,
      subject: `Confirmación de Suscripción ${title} Finanflix - Detalles de Pago Offline en ${bank}`,
      html: `
<!DOCTYPE html>
<html lang="es">
                ...
                <tr>
                  <td style="padding-bottom: 20px;" class="email-body">
                    ...
                    <p style="margin: 10px 0 0; color: #666666; font-size: 16px; line-height: 1.5;"> A
                      continuación, te proporcionamos los detalles para realizar el pago offline de tu suscripción:</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding-bottom: 20px;" class="email-body">
                    ...
                    <ul style="margin: 10px 0 0; padding-left: 20px; color: #000; font-size: 16px; line-height: 1.5;">
                      <li>ID de la Suscripción: <b>${suscriptionId}</b></li>
                      <li>Suscripción: <b style="text-transform: uppercase;">${title}</b></li>
                      <li>Precio: <b>$${bank === 'USD' ? `${price}USD` : `${priceArg} ARS`}</b></li>
                    </ul>
                  </td>
                </tr>
                  ...
                  <td style="padding-bottom: 20px;" class="email-body">
                    ...
                    <ul style="margin: 10px 0 0; padding-left: 20px; color: #000; font-size: 16px; line-height: 1.5;">
                      ...
                      <li>Monto a Transferir: <b>$${
                        bank === 'USD' ? `${price}USD` : `${priceArg} ARS`
                      }</b></li>
                    </ul>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding-bottom: 20px;" class="email-body">
                    ...
                    <ol
                      ...
                      <li>Envía el comprobante de pago a info@finanflix.com incluyendo tu nombre completo,
                        suscripción adquirida, monto y fecha de transferencia.</li>
                      <li>Espera nuestra confirmación (1-2 días hábiles).</li>
                      <li>Recibirás un correo de bienvenida con los detalles de acceso a la suscripción.</li>
                    </ol>
                  </td>
                </tr>
                <tr>
