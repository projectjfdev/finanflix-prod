...
export async function POST(req: Request) {
  ...
  const { username, userEmail, name, reason, price, currencyId } = body;
  ...
  try {
    let mailOptions: any = {
      from: AUTH_EMAIL,
      to: AUTH_EMAIL,
      subject: `El usuario ${username} ha dejado una compra pendiente - "${name}"`,
      html: `
<!DOCTYPE html>
<html lang="es">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
          <tr>
            <td style="padding: 20px; text-align: center; background-color: #4C2FBA;" class="email-header">
              <h1 style="margin: 0; color: #ffffff; font-size: 24px; font-weight: bold;">El usuario ${username} ha dejado una compra pendiente - "${name}"
              </h1>
            </td>
          </tr>
          <tr>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                ...
                <tr>
                  <td style="padding-bottom: 20px;" class="email-body">
                    <p style="margin: 10px 0 0; color: #666666; font-size: 16px; line-height: 1.5;">A continuación, te compartimos los detalles de la suscripcion pendiente.</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding-bottom: 20px;" class="email-body">
                    ...
                    <ul style="margin: 10px 0 0; padding-left: 20px; color: #000; font-size: 16px; line-height: 1.5;">
                      <li>Usuario registrado en Finanflix: <b>${username}</b></li>
                      <li>Email del usuario: <b>${userEmail}</b></li>
