...
export default function MobileLiveClassesCard({ classes, hasSubscription }: Props) {
  ...
  return (
    <>
      <div className="flex gap-3 sm:hidden overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 dark:scrollbar-thumb-gray-600 dark:scrollbar-track-gray-800 pb-2">
        {classes.map(item => (
          <Card
              ...
              >
                <div className="flex items-stretch p-3 gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-poppins font-medium text-base text-gray-900 dark:text-white truncate">
                      {item.title}
                    </h3>
