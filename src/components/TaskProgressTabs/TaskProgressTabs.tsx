        ...
        <div className="flex justify-start items-start md:mb-3 ">
          <TabsList className="flex justify-start gap-2 w-full sm:w-auto sm:inline-flex font-poppins">
            <div>
              <Button
                value="onboarding"
                className="hover:bg-secondary bg-secondary hover:text-white h-8 text-white font-poppins text-sm leading-tight sm:dark:bg-card"
              >
                Onboarding
              </Button>
            </div>
            ...
            <div className="sm:hidden">
              <Button
                value="onboarding"
                className="hover:bg-secondary  bg-secondary hover:text-white h-8 text-white font-poppins text-sm leading-tight dark:bg-card"
              >
                Comenzá
              </Button>
            </div>
            ...
            <CarouselItem className="basis-[60vw] md:basis-1/2 shrink-0">
              ...
              >
                <CardHeader>
                  ...
                  <CardDescription className="text-[10.49px]  pb-4  text-white dark:text-muted-foreground font-poppins ">
            ...
            <CarouselItem className="basis-[60vw] md:basis-1/2 shrink-0">
              <Card className="dark:bg-[#282844] bg-card text-white px-1 pt-5 rounded-3xl sm:min-w-[300px] h-[185px] md:min-w-full w-full  transition-transform duration-300 ease-in-out hover:scale-[1.009] hover:shadow-md">
                <CardHeader className="flex-grow px-5 relative top-2 ">
                  ...
                  <CardDescription className=" dark:text-white text-[#71767F] dark:text-muted-foreground text-[10.49px] font-poppins  ">
                ...
                <CardFooter className="mt-5 cursor-pointer w-full px-5">
                  <div className="w-full cursor-pointer py-4">
                    ...
                    <Button
                      className={cn(
                        'w-full text-white text-sm px-0 mx-0 flex relative top-1',
                        taskProgress?.perfilCompleted &&
            ...
            <CarouselItem className="basis-[60vw] md:basis-1/2 shrink-0">
              <Card className="dark:bg-[#282844] bg-card text-white px-1 pt-5 rounded-3xl sm:min-w-[300px] h-[185px] md:min-w-full w-full  transition-transform duration-300 ease-in-out hover:scale-[1.009] hover:shadow-md">
                <CardHeader className="flex-grow px-5 relative top-1">
                  <p className="relative top-1 dark:text-white text-[#71767F]  text-[10.49px] font-poppins">
                    Tarea 2
                  </p>
                  <CardTitle className="text-md dark:text-white text-black font-poppins">
                    Elegir Preferencias
            ...
            <CarouselItem className="basis-[60vw] md:basis-1/2 shrink-0">
              <Card className="dark:bg-[#282844] bg-card text-white px-1 pt-5 rounded-3xl sm:min-w-[300px] h-[185px] md:min-w-full w-full  transition-transform duration-300 ease-in-out hover:scale-[1.009] hover:shadow-md">
                <CardHeader className="flex-grow px-5 relative top-1">
                  ...
                  <CardDescription className=" dark:text-white text-[#71767F] dark:text-muted-foreground text-[10.49px] font-poppins ">
                    {isJoined ? 'CONECTADO A DISCORD' : 'Únete a nuestra comunidad'}
                  </CardDescription>
                </CardHeader>
                ...
                <CardFooter className="mt-5  w-full px-5 ">
                  <div className="w-full pt-2">
                    <Button
                      disabled={isJoined}
                      className={cn(
                        'w-full text-white text-sm cursor-pointer px-0 mx-0 flex ',
                        isJoined
                    ...
                    >
                      <span className="text-sm cursor-pointer font-poppins">
                        {isJoined
                          ? 'DONE'
                          : !!session?.user?.discordId &&
                            !session?.user?.discordConnected &&
