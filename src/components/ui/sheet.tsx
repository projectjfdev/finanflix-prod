...
// Importante: Se modifico el componente sheetcontent de shadcn para poder cambiar el ancho del contenedor del edit

const SheetContent = React.forwardRef<
  React.ElementRef<typeof SheetPrimitive.Content>,
  SheetContentProps
>(({ side = "right",width = "sm:max-w-sm ", className, children, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
    ...
    >
      <SheetPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100  disabled:pointer-events-none data-[state=open]:bg-secondary">
        <Cross2Icon className="h-8 w-[30px] " />
