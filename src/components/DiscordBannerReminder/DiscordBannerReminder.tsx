    ...
    <div className="md:w-full dark:bg-card bg-card py-3 px-4 rounded-2xl">
      <div className="flex flex-col 2xl:flex-row items-center justify-between gap-4">
        <div className="flex flex-col 2xl:flex-row items-center gap-3">
          ...
          />
          <span className="text-sm dark:text-white text-black font-medium w-full text-center 2xl:text-start ">
            Accede a la comunidad Finanflix para obtener seguimiento diario del mercado, clases en
            vivo y mucho más.
          </span>
        </div>

        <div className="flex flex-col 2xl:flex-row flex-wrap items-center gap-3 w-full sm:w-auto">
          <div className="flex items-center gap-2 text-xs dark:text-slate-300 text-black">
            ...
            <span>Unite al servidor</span>
            <ArrowRight className="h-3 w-3" />
            <div className={`rounded-full p-0.5 ${isJoined ? 'bg-green-800' : 'bg-[#4C2FBA]'}`}>
              <Check className="h-3 w-3 text-white" />
            </div>
            <span>Los roles pendientes serán asignados</span>
          </div>
          ...
          <div className="flex justify-center sm:flex-row gap-2 w-full ">
            <Button
              ...
              className={cn(
                'w-3/4 text-xs sm:text-[16px] font-poppins bg-[#4C2FBA] hover:bg-[#4752C4] text-white py-3 sm:py-6 rounded-xl px-6 md:px-12 dark:border-none border-none',
