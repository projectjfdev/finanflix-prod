    ...
    <>
      <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <Input
              type="text"
              placeholder="Satoshi "
              className="w-5/6 dark:bg-background bg-background border"
        ...
        <div className="space-y-1">
          ...
          <Input
            className=" dark:bg-background bg-background border"
            type="email"
            {...register('email', {
        ...
        <div>
          <Label className="block mb-2 text-left">País</Label>
          <Controller
            ...
            render={({ field }) => (
              <select
                ...
                className="w-full dark:bg-background bg-background rounded-xl focus:border-none focus:ring-0 border p-1"
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-4">
            <Input
              className="rounded-xl dark:bg-background bg-background border max-w-full w-[80px]"
              type="text"
            ...
            <Input
              className="rounded-xl dark:bg-background bg-background border"
              type="text"
        ...
        <Button
          ...
          className="w-full md:text-xl py-3 text-sm"
        >
          SIGUIENTE
        </Button>
      </form>
