...
import { getSuscriptionsToExport } from "@/utils/Endpoints/adminEndpoints";

const ExportSuscriptionsToExcel = () => {
  ...
  const getOrders = async () => {
    if (selectedStartDate && selectedEndDate) {
      ...
      const res = await getSuscriptionsToExport(query);
      setOrders(res.data);
    }
  };
  ...
  const handleExport = (): void => {
    ...
    link.href = url;
    link.setAttribute("download", "suscriptions.csv");
...
export default ExportSuscriptionsToExcel;
