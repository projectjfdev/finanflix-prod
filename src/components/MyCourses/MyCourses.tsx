...
export default async function MyCourses() {
  ...
  return (
    <div className="mb-20 dark:bg-background rounded-lg">
      <div className="container mx-auto overflow-hidden h-full">
        <MediumTitle title="Cursos de acceso permanente" className="mb-3 mt-7 text-2xl md:text-[26px]" />
            ...
            ? myEnrolledCourses.map(course => (
              ...
              >
                ...
                <CardContent className="flex flex-col justify-center flex-grow p-3 space-y-2 h-full">
                  <h3 className="text-xl font-semibold truncate text-black dark:text-white">
                    {course.title}
                  </h3>
                </CardContent>
