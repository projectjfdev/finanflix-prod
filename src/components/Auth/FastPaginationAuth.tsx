...
export const FastPaginationAuth = () => {
  ...
  return (
    <Card className=" dark:text-white text-black px-3 font-poppins">
      {page === 1 && (
        <>
          ...
          <div className="blur-in">
            <p className="mb-1 md:mb-2 text-base md:text-xl">
              El momento es ahora. <span className="hidden md:inline">Empieza gratis.</span>
            </p>
      ...
      <div className="flex flex-col gap-2 blur-in pt-3 md:w-[80%] ">
        {!errorMessage && (
          <Button
            // size={'xl'}
            className="rounded-md w-full md:text-xl py-6 md:px-36 md:py-6"
            onClick={handleNext}
          >
            Siguiente
          </Button>
