...
const VimeoPlayerWithCustomControls: React.FC<VimeoPlayerProps> = ({
  ...
  // Guardar la lección actual en localStorage cuando se carga el componente
  useEffect(() => {
    try {
    ...
    >
      {!videoEnded && (
        <div className="relative">
          ...
          <div
            className={`absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent pt-16 pb-6 px-4 transition-opacity duration-300 ${
      ...
      {videoEnded && isLastLesson && isModalOpen && (
